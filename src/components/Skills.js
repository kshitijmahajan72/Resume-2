            ...
            <div className="text-left mt-4 sub-topic">
                ...
                <div className="row">
                    ...
                    <ul className="list-unstyled mr-1" >
                            ...
                            <li className="skills"><span>ES6 <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className="es6"
                                width="20" height="20"
                                viewBox="0 0 172 172"
                    ...
                    <div className="col-md-5">
                        <ul className="list-unstyled mr-1" >
                            ...
                            <li className="skills"><span>AWS <img src="https://img.icons8.com/color/20/000000/amazon-web-services.png" alt="aws"/></span><span className="float-right star">
                                <span className="fa fa-star checked mx-1"></span>
                                <span className="fa fa-star checked mx-1"></span>
                                <span className="fa fa-star checked mx-1"></span>
                                <span className="fa fa-star mx-1"></span>
                            ...
                            <li className="skills"><span>JSON <img src="https://img.icons8.com/nolan/20/json.png" alt="json"/></span>
                            <span className="float-right star">
                                <span className="fa fa-star checked mx-1"></span>
                                <span className="fa fa-star checked mx-1"></span>
                                <span className="fa fa-star checked mx-1"></span>
